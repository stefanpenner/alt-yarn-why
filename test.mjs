...
describe('alt-yarn-why', function () {
  ...
  it('works', function () {
    expect(lib('./yarn.lock', 'something-non-existant')).to.eql({});
    ...
    expect(lib('./fixtures/ember-cli.lock', 'fs-extra')).to.eql({
      ...
      'fs-extra@^0.30.0': ['ember-cli-internal-test-helpers@^0.9.1', 'fixturify@^0.3.2'],
      'fs-extra@^4.0.2': ['yam@^1.0.0'],
      'fs-extra@^5.0.0': ['fast-sourcemap-concat@^2.1.0'],
      'fs-extra@^7.0.0': ['ember-cli-blueprint-test-helpers@^0.19.2'],
      'fs-extra@^8.0.1': ['broccoli-stew@^3.0.0', 'fs-merger@^3.1.0'],
      'fs-extra@^8.1.0': [
